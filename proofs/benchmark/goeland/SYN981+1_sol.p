...
fof(f11, plain, [~((((! [X7] : ((p(X7) => q(X7)))) & (? [Y9] : ((q(Y9) => r(Y9))))) => (? [Z11] : ((p(Z11) => r(Z11)))))), ((! [X7] : ((p(X7) => q(X7)))) & (? [Y9] : ((q(Y9) => r(Y9))))), ~((? [Z11] : ((p(Z11) => r(Z11))))), (! [X7] : ((p(X7) => q(X7)))), (? [Y9] : ((q(Y9) => r(Y9)))), (q(Sko_0) => r(Sko_0)), ~(q(Sko_0)), ~((p(Sko_0) => r(Sko_0))), p(Sko_0), ~(r(Sko_0)), (p(Sko_0) => q(Sko_0))] --> [], inference(leftImp2, [status(thm), 10], [f12, f13])).
