...
fof(tsStepExpl3, plain, [$phi,$tsStep0,$tsStep1,$tsStep2] --> [! [Xy]: ((sP(V0) | sQ(Xy)) & Ts5)], inference(leftForall, [status(thm), 3, $fot(V1)], [tsStepExpl5])).
fof(tsStepExpl6, plain, [$phi,$tsStep0,$tsStep1,(Ts2(V0,V1) <=> (sP(V0) | sQ(V1)))] --> [! [Xy]: ((sP(V0) | sQ(Xy)) & Ts5)], inference(rightSubstIff, [status(thm), 3, 1, $fof(! [Xy]: ((sP(V0) | sQ(Xy)) & Ts5)), 'A'], [tsStepExpl5])).
fof(-1, plain, [$phi,$tsStep0,$tsStep1,$tsStep2] --> [! [Xy]: ((sP(V0) | sQ(Xy)) & Ts5)], inference(leftForall, [status(thm), 3, $fot(V0)], [tsStepExpl6])).
