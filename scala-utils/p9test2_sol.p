...
fof(ts_claQ1_1_p9r, plain, [$r3,$r2,$r1] --> [~Ts1(V0),~p(Sk5(V0))], inference(instMult, [status(thm), [tuple3('V0', $fot(V0), [])]], [${t1}])).
fof(ts_clbQ1_1_p9r, plain, [$r3,$r2,$r1] --> [~Ts1(V0),p(V0)], inference(instMult, [status(thm), [tuple3('V0', $fot(V0), [])]], [${t1}])).
fof(ts_axQ1_1_p9r, plain, [$r3,$r2,$r1] --> [Ts1(V0)], inference(instMult, [status(thm), [tuple3('V0', $fot(V0), [])]], [${t1}])).
fof(8, plain, [$r3,$r2,$r1] --> [Ts1(V100)], inference(instantiateMultP9, [status(thm), [tuple3('V0', $fot(V100), [])]], [ts_axQ1_1_p9r])).
fof(9, plain, [$r3,$r2,$r1] --> [~Ts1(V100),p(V100)], inference(instantiateMultP9, [status(thm), [tuple3('V0', $fot(V100), [])]], [ts_clbQ1_1_p9r])).
fof(10, plain, [$r3,$r2,$r1] --> [p(V100)], inference(res, [status(thm), 0], [8, 9])).
fof(5, plain, [$r3,$r2,$r1] --> [p(V0)], inference(instantiateMultP9, [status(thm), [tuple3('V100', $fot(V0), [])]], [10])).
fof(11, plain, [$r3,$r2,$r1] --> [Ts1(V100)], inference(instantiateMultP9, [status(thm), [tuple3('V0', $fot(V100), [])]], [ts_axQ1_1_p9r])).
fof(12, plain, [$r3,$r2,$r1] --> [~Ts1(V100),~p(Sk5(V100))], inference(instantiateMultP9, [status(thm), [tuple3('V0', $fot(V100), [])]], [ts_claQ1_1_p9r])).
fof(13, plain, [$r3,$r2,$r1] --> [~p(Sk5(V100))], inference(res, [status(thm), 0], [11, 12])).
fof(6, plain, [$r3,$r2,$r1] --> [~p(Sk5(V0))], inference(instantiateMultP9, [status(thm), [tuple3('V100', $fot(V0), [])]], [13])).
fof(14, plain, [$r3,$r2,$r1] --> [p(Sk5(V100))], inference(instantiateMultP9, [status(thm), [tuple3('V0', $fot(Sk5(V100)), [])]], [5])).
fof(15, plain, [$r3,$r2,$r1] --> [~p(Sk5(V100))], inference(instantiateMultP9, [status(thm), [tuple3('V0', $fot(V100), [])]], [6])).
