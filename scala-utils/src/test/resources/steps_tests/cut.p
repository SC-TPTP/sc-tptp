fof(a1_1, axiom, [p] --> [q]).
fof(a1_2, axiom, [q] --> [r]).
fof(f1, plain, [p] --> [r], inference(cut, [status(thm), 0, 0], [a1_1, a1_2])).

fof(a2_1, axiom, [p, q] --> [r, s]).
fof(a2_2, axiom, [s, t] --> [u, v]).
fof(f2, plain, [p, q, t] --> [r, u, v], inference(cut, [status(thm), 1, 0], [a2_1, a2_2])).

fof(a3_1, axiom, [p(X) & Q(X, Y), r(Y)] --> [s(X, c)]).
fof(a3_2, axiom, [s(X, c)] --> [r(t)]).
fof(f3, plain, [p(X) & Q(X, Y), r(Y)] --> [r(t)], inference(cut, [status(thm), 0, 0], [a3_1, a3_2])).
