fof(a1_1, axiom, [p] --> [q]).
fof(a1_2, axiom, [q] --> [r]).
fof(f1, plain, [p] --> [r], inference(cut, [0, 0], [a1_1, a1_2])).

fof(a2_1, axiom, [p, q] --> [r, s]).
fof(a2_2, axiom, [s, t] --> [u, v]).
fof(f2, plain, [p, q, t] --> [r, u, v], inference(cut, [1, 0], [a2_1, a2_2])).
...
fof(f4, plain, [![X, Y] : (p(X) & Q(X, Y)), r(Y)] --> [![Y] : r(f(t))], inference(cut, [0, 0], [a4_1, a4_2])).
