fof(a1, axiom, [p] --> []).
fof(f1, plain, [] --> [~p], inference(rightNot, [0], [a1])).

fof(a2, axiom, [r] --> [q]).
fof(f2, plain, [] --> [~r, q], inference(rightNot, [0], [a2])).

fof(a3, axiom, [r, p] --> [q]).
fof(f3, plain, [p] --> [~r, q], inference(rightNot, [0], [a3])).

fof(a4, axiom, [q(X)] --> [p(X)]).
fof(f4, plain, [] --> [p(X), ~q(X)], inference(rightNot, [1], [a4])).
